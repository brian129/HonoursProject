...
exports.getDefaultHeaders = function(options) {
	if (!options || !options.serviceName)
		throw new Error("Need serviceName for default params");
	...
	switch (options.serviceName) {
		case "Finding":
			return {
				...
				"X-EBAY-SOA-GLOBAL-ID": options.globalId ? options.globalId : "EBAY-GB",
				"X-EBAY-SOA-SERVICE-VERSION": options.version
					? options.version
					: "1.13.0",
		...
		case "Product":
			return {
				...
				"GLOBAL-ID": options.globalId ? options.globalId : "EBAY-GB",
		...
		case "Shopping":
			return {
				...
				"X-EBAY-API-SITE-ID": options.siteId ? options.siteId : "3", // UK
		...
		case "Trading":
			return {
				...
				"X-EBAY-API-CALL-NAME": options.opType,
				"X-EBAY-API-COMPATIBILITY-LEVEL": options.version
					? options.version
					: "775",
